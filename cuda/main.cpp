...
int main()
{
    CImg<unsigned char> inputImage("images-input/inputHequalization.bmp");
    CImg<unsigned char> result(inputImage.width(), inputImage.height(), 1, 3);
    CUDACLAHE(inputImage, result, inputImage.width(), inputImage.height(), 2, 96);
    result.save("images-output/enhance-clahe.png");
